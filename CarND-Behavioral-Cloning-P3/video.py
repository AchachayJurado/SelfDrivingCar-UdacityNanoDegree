...
"""
----------------------------------------------------------------------------------------------------
This script requires an argument containing the path to the images to be grouped into a video
the video output will be placed in the same folder IMG_DIRECTORY/output_video.mp4
----------------------------------------------------------------------------------------------------
"""
...
def main():
    ...
    # Converting file folder into list filtered for image file types
